...
```
npm install xprezzo-file-upload
```
...
```js
var fileUpload = require('xprezzo-file-upload');
...
```js
var form = new fileUpload.Form(options)
```
...
**By default xprezzo-file-upload will not touch your hard drive.** But if you add this
listener, xprezzo-file-upload automatically sets `form.autoFiles` to `true` and will
